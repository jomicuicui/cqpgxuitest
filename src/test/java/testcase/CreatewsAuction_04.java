...
public class CreatewsAuction_04 {
    WebDriver driver;
    ...
    public void test03_createbid() throws InterruptedException {
        ...
        createwsAuctionObject.sellercreatewsAuctionObject_03(minweight,linkman,contactphone,maxweight,baseprice,bidperprice,bidperpeight,wsordername);
    }
