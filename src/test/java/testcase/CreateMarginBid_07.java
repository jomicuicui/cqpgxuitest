...
//卖家发起竞标，后台审批通过
public class CreateMarginBid_07 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginBidObject.CreateMarginBid6(marginordername, bidweight, minweight, maxweight, linkman, contactphone, settlecycle, baseprice, bidperprice, bidperpeight, gasRatenum);
    }
