...
public class CreateMarginAuction_06 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginAuctionObject.CreateAuction5( marginordername, bidweight, minweight, maxweight, linkman, contactphone, settlecycle, baseprice, bidperprice, bidperpeight,gasRatenum);
