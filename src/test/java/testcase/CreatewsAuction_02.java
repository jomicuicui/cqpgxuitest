...
import pageobject.CreatewsAuctionObject;
...
//结清仓储费后，卖家发起仓单竞标，后台审批通过，买家竞标

public class CreatewsAuction_02 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        CreatewsAuctionObject createwsAuctionObject = new CreatewsAuctionObject(driver);
        createwsAuctionObject.sellercreatewsAuctionObject_01(minweight,linkman,contactphone,maxweight,baseprice,bidperprice,bidperpeight,wsordername);
    }
