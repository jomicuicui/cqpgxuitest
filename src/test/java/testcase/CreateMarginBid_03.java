...
//卖家发起竞标，后台审批通过
public class CreateMarginBid_03 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginBidObject.CreateMarginBid2(marginordername, bidweight, minweight, linkman, contactphone, maxweight, settlecycle, basepriceshow, bidperprice, bidperpeight);
