...
public class CreateMarginAuction_04 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginAuctionObject.CreateAuction3( marginordername, bidweight, minweight, maxweight, linkman, contactphone, settlecycle, basepriceshow, bidperprice, bidperpeight);
