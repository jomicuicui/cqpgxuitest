...
//卖家发起竞标，后台审批通过
public class CreateMarginBid_04 {
    WebDriver driver;
    ...
    String ordername = utils.showConfig().getProperty("ordername");
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginBidObject.CreateMarginBid3(marginordername, bidweight, minweight, maxweight, linkman, contactphone, settlecycle, baseprice, bidperprice, bidperpeight);
    }
    ...
    public void test04_buyerbid() throws InterruptedException {
        ...
        buyerbid.PlaceBidwithoutExecutionunit(bid_rowprice2,bid_rowweight2);
    }
