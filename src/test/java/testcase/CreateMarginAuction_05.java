...
public class CreateMarginAuction_05 {
    WebDriver driver;
    ...
    public void test02_createbid() throws InterruptedException {
        ...
        createMarginAuctionObject.CreateAuction4( marginordername, bidweight, minweight, maxweight, linkman, contactphone, settlecycle, basepriceshow, bidperprice, bidperpeight);
    ...
    public void test04_buyerauction() throws InterruptedException {
        ...
        buyerauction.PlaceAuctionwithoutExecutionunit(bid_rowprice1,bid_rowweight1);
