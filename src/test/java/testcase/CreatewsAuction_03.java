 ...
 **/
public class CreatewsAuction_03 {
    WebDriver driver;
    ...
    public void test03_createbid() throws InterruptedException {
        ...
        createwsAuctionObject.sellercreatewsAuctionObject_02(minweight,linkman,contactphone,maxweight,baseprice,bidperprice,bidperpeight,wsordername);
    }
