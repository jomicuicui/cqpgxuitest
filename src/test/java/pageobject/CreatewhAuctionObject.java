 ...
 **/
public class CreatewhAuctionObject {
    WebDriver driver;

    public CreatewhAuctionObject(WebDriver driver){
        this.driver = driver;
...
//第一种组合
    ...
    public void CreatewhAuctionObject_01(String minweight,String linkman,String contactphone,String maxweight,String baseprice,String bidperprice,String bidperpeight,String whordername) throws InterruptedException {
...
//第一种组合
    ...
    黑白名单：不启用
     */
    public void CreatewhAuctionObject_02(String minweight,String linkman,String contactphone,String maxweight,String baseprice,String bidperprice,String bidperpeight,String whordername) throws InterruptedException {
        Create_MarginorderFactory createBid_factory = new Create_MarginorderFactory(driver);
        Create_WhorderFactory createWhFactory = new Create_WhorderFactory(driver);
