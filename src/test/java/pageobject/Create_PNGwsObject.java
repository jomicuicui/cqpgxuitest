 ...
 **/
public class Create_PNGwsObject {
    WebDriver driver;



    public Create_PNGwsObject(WebDriver driver){
        this.driver = driver;
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    }
    //卖家申请入库
    public void Createws_stepone(String preweight) throws InterruptedException {
    ...
    //仓库管理员入库、入库复核
    public void Createws_steptfour(String preweight,String position_duo,String position_store) throws InterruptedException {
        Create_WsorderFactory createWsFactory = new Create_WsorderFactory(driver);
        //点击仓储系统菜单按钮
        createWsFactory.setWhws_menu();
        //点击入库管理菜单
